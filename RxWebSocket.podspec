...
Pod::Spec.new do |s|
  s.name             = "RxWebSocket"
  s.version          = "0.1.0"
  s.summary          = "A short description of RxWebSocket."
...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/RxWebSocket.git", :tag => s.version.to_s }
